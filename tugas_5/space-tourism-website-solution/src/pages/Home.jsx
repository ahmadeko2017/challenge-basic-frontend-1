    ...
    return (
        <div className="relative w-full min-h-screen overflow-hidden">
            ...
            {/* ========================================
                ...
                ======================================== */}
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pt-20 pb-12 flex flex-col lg:flex-row items-center lg:items-center justify-between gap-12 lg:gap-0 min-h-screen">
                <motion.div
